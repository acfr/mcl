...
exclude_patterns = ['aliases.rst', 'coverage.rst']
...
latex_documents = [
  ('index', 'mcl.tex', u'MCL Documentation',
   u'ACFR Intelligent Vehicles and Safety Systems Group', 'manual'),
]
...
man_pages = [
    ('index', 'MCL', u'MCL Documentation',
     [u'ACFR Intelligent Vehicles and Safety Systems Group'], 1)
]
...
texinfo_documents = [
  ('index', 'MCL', u'MCL Documentation',
   u'ACFR Intelligent Vehicles and Safety Systems Group',
   'mcl', 'Multiprocess Communication Library.',
   'Miscellaneous'),
]
